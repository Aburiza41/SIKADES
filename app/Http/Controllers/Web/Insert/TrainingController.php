    ...
    protected function insert($official, $data)
    {
        try {
            ...
            $workPlaceInsert = [
                ...
                'alamat' => $data['tempatpelatihan'],
                'pelatihan' => $pelatihan,
                'keterangan' => $data['keteranganpelatihan'],
                'penyelenggara' => $data['penyelenggara'],
                'nomor_sertifikat' => $data['nosertifikat'],
                'tanggal_sertifikat' => $data['tanggalsertifikat'],
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ];

            DB::table('official_trainings')->insert($workPlaceInsert);
        } catch (\Exception $e) {
