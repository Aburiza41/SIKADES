        ...
        >
            <div className="space-y-0 border-b">
                ...
                <h1 className="text-2xl font-semibold text-gray-700">
                    G. DATA ORANG TUA KANDUNG
                </h1>
                {/* Keterangan Formulir */}
                <p className="text-sm text-gray-500">
                    Formulir ini digunakan untuk mengisi tempat kerja pejabat
                    desa.
                </p>
            </div>

            <div className="space-y-4">
                <div className="border-b pb-8 grid gap-4">
