...
import OfficialFilter from "./Partials/Component/Filter";
...
export default function Official({
    ...
    const handleEdit = (official, role) => {
        window.location.href = `/admin/official/${role}/${official.nik}/edit`;
    };
    ...
    const handleDelete = (official, role) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(
                    `/admin/official/${role}/${official.nik}/delete`,
                    {
                        headers: {
    ...
    const handleAccept = (official) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.put(
                    `/admin/official/${official.nik}/accept`,
                    {},
                    {
                        onSuccess: () => {
                            Swal.fire(
    ...
    const handleReject = (official) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.put(
                    `/admin/official/${official.nik}/reject`,
                    {},
                    {
                        onSuccess: () => {
                            Swal.fire(
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const url = isEdit
            ? `/admin/official/${role}/${selectedOfficial.id}`
            : `/admin/official/${role}`;
    ...
    return (
        ...
        >
            ...
            <div className="py-6 max-w-full px-4 mx-auto">
                ...
                {/* Filter Section */}
                <OfficialFilter onFilter={handleFilterChange} />
