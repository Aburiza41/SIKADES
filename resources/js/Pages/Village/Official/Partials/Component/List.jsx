...
export default function List({
    ...
    const CustomBadge = ({ role }) => {
        ...
        switch (role) {
            case "tolak":
                badgeColor = "bg-red-500 w-full text-center";
                roleName = "Tolak";
                break;
            case "daftar":
                badgeColor = "bg-blue-500 w-full text-center";
                roleName = "Daftar";
                break;
            case "validasi":
                badgeColor = "bg-green-500 w-full text-center";
                roleName = "Terima";
                break;
            case "proses":
                badgeColor = "bg-yellow-500 w-full text-center";
                roleName = "Proses";
                break;
            default:
                badgeColor = "bg-gray-500 w-full text-center";
