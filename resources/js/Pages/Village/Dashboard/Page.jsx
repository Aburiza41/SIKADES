...
export default function Dashboard({regency, district, village, official, status_pejabat, jenis_kelamin, pendidikan, posisi}) {
    // console.log(regency);
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        >
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-2xl font-semibold">{district.name_bps}</p>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-2xl font-semibold">{village.name_bps}</p>
                            </div>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-xs font-semibold">
                                    Jumlah minimal AD : 1 x {posisi} APD = {(1 * posisi).toLocaleString('id-ID')}
                                </p>
                                <p className="text-3xl font-semibold">
                                    {((1 * posisi) - official).toLocaleString('id-ID')}
                                </p>
                            </div>
                        </motion.div>
                    </div>
